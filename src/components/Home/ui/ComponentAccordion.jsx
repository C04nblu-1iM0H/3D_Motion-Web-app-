...
export default function ComponentAccordion(){
    ...
    return (
        <section className="mt-36">
             <h1 className="text-2xl font-semibold text-center capitalize lg:text-4xl lg:mt-10 lg:mb-16">
                Программа курса
            </h1>
            <div className="mb-20">
                {programKurs.title.map((title, index) => (
                    <Accordion key={index} title={title} items={programKurs.items[index]} />
                ))}
            </div>
        </section>
    );
