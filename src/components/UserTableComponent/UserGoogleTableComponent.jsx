...
import DeleteComponent from "@/app/googletable/delete";
import EditGoogle from "@/app/googletable/edit";
import ViewGoogleComponent from "@/app/googletable/view";
import SpinnerWithBackdrop from "../Button/Spinner";

export default function UserGoogleTableComponent({users}) {
        ...
        <Table aria-label="Example table with custom cells">
            ...
            <TableBody loadingContent={<SpinnerWithBackdrop label="Loading..." />}>
                ...
                <TableRow key={user.id}>
                    ...
                    <TableCell>{user.emailGoogle}</TableCell>
                    ...
                    <div className="relative flex items-center justify-center">
                        ...
                        <Tooltip color="warning" content="Edit user">
                            <span className="text-lg text-default-400 cursor-pointer active:opacity-50">
                                <EditGoogle userid={user.id} emailGoogle={user.emailGoogle} user_role={user.id_role}/>
                            </span>
                        </Tooltip>
